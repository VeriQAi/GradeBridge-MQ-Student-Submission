// =====================================================
// GradeBridge Encoding Service - MQ Student Submission
// =====================================================
// AES-256-GCM symmetric encryption using the Web Crypto API.
// Key MUST match GradeBridge-MQ-Assignment-Maker/cryptoService.ts and the
// Python autograder. Do not change without coordinated rotation.
//
// FORMAT
